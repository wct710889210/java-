package com.wct.redis.redisInAction;

import com.wct.redis.ConnectionFactory;
...
public class Chapter04 {
    ...
    public void run() {
        Jedis conn = ConnectionFactory.getConn();
        conn.select(15);
    ...
    public boolean purchaseItem(
        ...
        String buyer = "users:" + buyerId;  //买家
        String seller = "users:" + sellerId;    //卖家
        String item = itemId + '.' + sellerId;  //交易的货物
        String inventory = "inventory:" + buyerId;  //买家包裹
        long end = System.currentTimeMillis() + 10000;

        while (System.currentTimeMillis() < end){
            conn.watch("market:", buyer);   //监视商场和买家
